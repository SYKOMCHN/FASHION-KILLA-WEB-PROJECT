...
('Black Tee', 19.99, 'assets/extras/yessir.png', 'Comfortable cotton tee', 20),
('Denim Jacket', 59.99, 'assets/extras/yessir.png', 'Classic denim jacket', 8),
('White Sneakers', 79.99, 'assets/extras/yessir.png', 'Lightweight running sneakers', 12);
"""
